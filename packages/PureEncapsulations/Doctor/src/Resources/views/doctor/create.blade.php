...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('doctor.store') }}" @submit.prevent="onSubmit">
...
{{--                        {{ __('admin::app.customers.customers.save-btn-title') }}--}}
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('doctor_id') ? 'has-error' : '']">
                        <label for="doctor_reg" class="required">ID do Médico</label>
                        <input type="text" class="control" name="doctor_reg" v-validate="'required'" value="{{ old('doctor_reg') }}">
                    ...
                    <div class="control-group" :class="[errors.has('patient') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="patient" v-validate="'required'" value="{{ old('patient') }}">
                    ...
                    <div class="control-group" :class="[errors.has('prescription_date') ? 'has-error' : '']">
                        ...
                        <input type="date" class="control" name="prescription_date" v-validate="" value="{{ old('prescription_date') }}">
                    ...
                    <div id="disable" style="display: none;">
                        ...
                        <div class="control-group" :class="[errors.has('purchase_date') ? 'has-error' : '']">
                            ...
                            <input type="date" class="control" name="purchase_date" v-validate="" value="{{ old('purchase_date') }}">
                        ...
                        <div class="control-group" :class="[errors.has('order_number') ? 'has-error' : '']">
                            ...
                            <input type="text" class="control" name="order_number" v-validate="" value="{{ old('order_number') }}">
