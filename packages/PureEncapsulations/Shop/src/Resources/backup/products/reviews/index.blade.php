...
@section('content-wrapper')
    ...
    <section class="review">
        ...
        <div style="width: 100%; margin-left: 20%; justify-content: center;">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price mt-10">
                        @if ($product->getTypeInstance()->haveSpecialPrice())
                            <span class="pro-price">{{ core()->currency($product->getTypeInstance()->getSpecialPrice(), $product) }}</span>
                        @else
                            <span class="pro-price">{{ core()->currency($product->price, $product) }}</span>
                        @endif
                    </div>
                </div>
