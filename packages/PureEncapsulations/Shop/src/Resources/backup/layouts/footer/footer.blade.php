...
<div class="scientific">
    <b>Scientific Practitioner Advisory:</b> (11) 9 7528-5558
</div>
            ...
            <div class="footer-bg pb-50">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="footer-wrapper pl-25 mb-30">
                            <div class="footer-logo">
                                <img src="{{ bagisto_asset('img/logo/nestle-health-science.png') }}" alt="Nestlé Health Science" />
                                <small><strong>PureEncapsulations</strong> é uma marca Nestlé Health Science Global.</small>
                            </div>
                        </div>
                    </div>
                </div>
