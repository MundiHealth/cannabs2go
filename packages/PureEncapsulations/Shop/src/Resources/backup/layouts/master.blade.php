...
<head>
    ...
    <title>@yield('page_title') | Pure Encapsulations</title>
    @section('seo')
        @if (! request()->is('/'))
...
{{--    <link rel="stylesheet" href="{{ asset('vendor/webkul/ui/assets/css/ui.css') }}">--}}
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-151953261-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-151953261-1');
    </script>
