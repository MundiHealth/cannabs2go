...
return [
    ...
    'wishlist' => [
        ...
        'moveall' => 'Mover Todos para o Carrinho',
        'move-to-cart' => 'Mover para o Carrinho',
        'error' => 'Não foi possível adicionar o produto à lista de desejos devido a problemas desconhecidos, tente mais tarde.',
        'add' => 'Item adicionado com sucesso à lista de desejos.',
        ...
        'move-error' => 'O item não pode ser movido para a lista de desejos. Tente novamente mais tarde.',
        'success' => 'Item adicionado com sucesso à lista de desejos.',
        'failure' => 'O item não pode ser adicionado à lista de desejos. Tente novamente mais tarde.',
        'already' => 'O item já consta em sua lista de desejos.',
        'removed' => 'Item removido com sucesso da lista de desejos.',
        'remove-fail' => 'O item não pode ser removido da lista de desejos. Tente novamente mais tarde.',
        'empty' => 'Você não possui nenhum item na sua lista de desejos.',
