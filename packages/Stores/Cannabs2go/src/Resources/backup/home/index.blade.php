...
{{--    {!! DbView::make($channel)->field('home_page_content')->with(['sliderData' => $sliderData])->render() !!}--}}
    ...
    <div class="slider-area">
        <div class="main-slider">
            <div class="item -bariatric d-flex align-items-center" style="background-image: url('{{ bagisto_asset('img/slider/bariatric-advantage.jpg') }}')">
                <div class="container">
                    <div class="col-12 col-sm-6 col-md-5">
                        <div class="slider-content">
                            ...
                            <a href="{{url()->to('/nossos-produtos/produtos?sort=name&order=asc')}}" class="btn">Comprar</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="categories-item">
                    <div class="categories-wrapper text-center mb-30">
                        <div class="categories-text">
                            ...
                            <a href="{{url()->to('/nossos-produtos/suporte-imunologico')}}" class="btn">Comprar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="categories-item">
                    <div class="categories-wrapper text-center mb-30">
                        <div class="categories-text">
                            ...
                            <a href="{{url()->to('/nossos-produtos/gastrointestinal')}}" class="btn">Comprar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="categories-item">
                    <div class="categories-wrapper text-center mb-30">
                        <div class="categories-text">
                            ...
                            <a href="{{url()->to('/nossos-produtos/figado-destoxificacao')}}" class="btn">Comprar</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <a href="{{url()->to('/nossos-produtos/produtos?sort=name&order=asc')}}" class="btn">Encontre um produto</a>
                </div>
            </div>
        </div>
    </div>
