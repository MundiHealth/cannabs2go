    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                ...
                Route::get('/orders/link-ebanx/{id}', 'Webkul\Admin\Http\Controllers\Sales\OrderController@linkEbanx')->defaults('_config', [
                    'view' => 'admin::sales.orders.link-ebanx'
                ])->name('admin.sales.orders.link-ebanx');

                Route::get('/orders/zero/{id}', 'Webkul\Admin\Http\Controllers\Sales\OrderController@zero')->defaults('_config', [
                    'view' => 'admin::sales.orders.zero'
                ])->name('admin.sales.orders.zero');
                ...
                Route::get('/invoices/zip/{id}', 'Webkul\Admin\Http\Controllers\Sales\InvoiceController@zip')->defaults('_config', [
                    'view' => 'admin::sales.invoices.zip'
                ])->name('admin.sales.invoices.zip');
            ...
            Route::prefix('catalog')->group(function () {
                ...
                Route::get('products/price', 'Webkul\Product\Http\Controllers\ProductController@price')->defaults('_config', [
                    'view' => 'admin::catalog.products.price'
                ])->name('admin.catalog.products.price');

                Route::post('products/price', 'Webkul\Product\Http\Controllers\ProductController@priceUpdate')->defaults('_config', [
                    'redirect' => 'admin.catalog.products.index'
                ])->name('admin.catalog.products.price-mass-update');
                ...
                ])->name('admin.catalog.products.inventory.index');

                Route::post('products/inventory/{id}', 'Webkul\Product\Http\Controllers\ProductController@inventoryUpdate')->defaults('_config', [
                    'redirect' => 'admin.catalog.products.index'
                ])->name('admin.catalog.products.inventory.update');
