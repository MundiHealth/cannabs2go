...
class ShipmentController extends Controller
{
    ...
    public function store($orderId)
    {
        ...
        $this->validate(request(), [
            ...
            'shipment.items.*.*' => 'required|numeric',
        ]);
...
//        }
    ...
    public function trackingFedex(Request $request)
    {
        $orderId = $request->order_id;
        $order = Order::find($orderId);
        $order->awb_code = $request->trackingNumber;
        $order->save();

        session()->flash('success', 'Número de rastreio salvo com sucesso.');
        return redirect()->back();
    }
}
