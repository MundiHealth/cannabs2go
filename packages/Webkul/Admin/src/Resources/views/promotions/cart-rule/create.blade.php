                                ...
                                <div slot="body">
                                    ...
                                    <div>
                                        <div class="control-group" :class="[errors.has('code') ? 'has-error' : '']">
                                            ...
                                            <input type="text" class="control" name="code" v-model="code" v-validate="'required'" value="{{ old('code') }}" data-vv-as="&quot;{{ __('admin::app.promotion.general-info.code') }}&quot;" @change="toUpper">
            ...
            Vue.component('cart-rule', {
                ...
                methods: {
                    ...
                    toUpper: function() {
                        ...
                        this_this.code = this.code.toUpperCase();
                    },
