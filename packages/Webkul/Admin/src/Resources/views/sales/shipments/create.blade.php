                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="control-group" :class="[errors.has('{{ $inputName }}') ? 'has-error' : '']">
                                                            ...
                                                            <input type="text" v-validate="'required|numeric'" class="control" id="{{ $inputName }}" name="{{ $inputName }}" value="0" data-vv-as="&quot;{{ __('admin::app.sales.shipments.qty-to-ship') }}&quot;" :disabled="source != '{{ $inventorySource->id }}'"/>
