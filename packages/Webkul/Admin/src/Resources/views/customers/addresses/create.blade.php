                                ...
                                <accordian :title="'{{ __('admin::app.customers.addresses.general') }}'" :active="true">
                                    <div slot="body">
                                        ...
                                        <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                                            ...
                                            <input type="text" class="control" name="address1[]" id="address_0"  value="{{ old('address1') }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.street-address') }}&quot;">
                                            ...
                                            <div class="control-group">
                                                @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                                                    ...
                                                    <input type="text" class="control" name="address1[{{ $i }}]"
                                                           id="address_{{ $i }}"
                                                           @if( $i != 2) required="required" @endif
                                        ...
                                        <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                                            ...
                                            <input type="text" class="control" name="city" id="city" v-validate="'required|alpha_spaces'" value="{{ old('city') }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.city') }}&quot;">
                                        ...
                                        <div class="control-group" :class="[errors.has('state') ? 'has-error' : '']">
                                            ...
                                            <input type="text" class="control" id="state" name="state" v-validate="'required'"
                                        ...
                                        <div class="control-group" :class="[errors.has('taxvat') ? 'has-error' : '']">
                                            ...
                                            <input type="text" class="control cpf" name="taxvat" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.taxvat') }}&quot;">
