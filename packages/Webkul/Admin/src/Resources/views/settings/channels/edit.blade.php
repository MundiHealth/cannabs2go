                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.settings.channels.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('profit_margin') ? 'has-error' : '']">
                                <label for="code">{{ __('admin::app.settings.channels.profit_margin') }}</label>
                                <input type="text" class="control" id="profit_margin" name="profit_margin" data-vv-as="&quot;{{ __('admin::app.settings.channels.profit_margin') }}&quot;" value="{{ $channel->profit_margin }}"/>
                                <span class="control-error" v-if="errors.has('profit_margin')">@{{ errors.first('profit_margin') }}</span>
                            </div>
