...
class AddressController extends Controller
{
    ...
    public function store()
    {
        ...
        if(count($endereco) == 1) {
            ...
            $rua = isset($endereco[0])? $endereco[0]:null;
            $numero = isset($endereco[1])? $endereco[1]:null;
            $complemento = null;
            $bairro = isset($endereco[2])? $endereco[2]:null;
