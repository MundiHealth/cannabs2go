...
class PriceUpdate extends Command
{
    ...
    */
    ...
    {
        $products = $this->productFlatRepository->all();
        ...
        foreach ($products as $product) {
            ...
            if ($product->parent) {
                $product->min_price = $product->parent->min_price = $product->parent->getTypeInstance()->getMinimalPrice();

                $product->max_price = $product->parent->max_price = $product->parent->getTypeInstance()->getMaximamPrice();
