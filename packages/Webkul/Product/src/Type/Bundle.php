    ...
    */
    ...
    public function getProductPrices()
    {
        return [
            'from' => [
                'regular_price' => [
                    'price' => core()->convertPrice($this->getRegularMinimalPrice(), $this->moeda_base_label == 'BRL' ? 'USD' : core()->getCurrentCurrency()->code),
                    'formated_price' => core()->currency($this->getRegularMinimalPrice(), $this)
                ],
                'final_price' => [
                    'price' => core()->convertPrice($this->getMinimalPrice(), $this->moeda_base_label == 'BRL' ? 'USD' : core()->getCurrentCurrency()->code),
                    'formated_price' => core()->currency($this->getMinimalPrice(), $this)
                ]
            ],
            'to' => [
                'regular_price' => [
                    'price' => core()->convertPrice($this->getRegularMaximamPrice(), $this->moeda_base_label == 'BRL' ? 'USD' : core()->getCurrentCurrency()->code),
                    'formated_price' => core()->currency($this->getRegularMaximamPrice(), $this)
                ],
                'final_price' => [
                    'price' => core()->convertPrice($this->getMaximamPrice(), $this->moeda_base_label == 'BRL' ? 'USD' : core()->getCurrentCurrency()->code),
                    'formated_price' => core()->currency($this->getMaximamPrice(), $this)
                ]
            ]
        ];
    }
