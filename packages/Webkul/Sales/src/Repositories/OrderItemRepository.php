...
class OrderItemRepository extends Repository
{
    ...
    public function manageInventory($orderItem)
    {
        ...
        foreach ($orderItems as $item) {
            ...
            $productInventory = $item->product->inventories()->first();
    ...
    public function returnQtyToProductInventory($orderItem)
    {
        ...
        $productInventory = $orderItem->product->inventories()->first();
        $productInventory->qty += $orderItem->qty_ordered ? $orderItem->qty_to_cancel : $orderItem->parent->qty_ordered;
        $productInventory->update();
    }
}