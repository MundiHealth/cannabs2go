...
@section('page_title')
    {{ 'CBD Daily Duo - Óleo de CBD sem THC, incomparável em pureza e sabor' }}
@endsection
...
@section('content-wrapper')
    ...
    <div class="info-area pt-60 pb-60">
        <div class="container">
            <div class="info">
                <div class="-text">
                    <h2>Foco de dia, relaxamento à noite</h2>

                    <p>Um kit completo para apoiá-lo de dia ou à noite. O CBD Oil vai deixar você focado e pronto para o dia. O CBD Night Oil fará você cair no sono rapidamente e dormir tranquilamente. Melhor de tudo? Tem sabor de sorvete de laranja!</p>
                </div>
                <div class="-img">
                    <img src="{{ bagisto_asset('img/produtos/cbd-daily-duo/foco-relax.jpg') }}" alt="Foco de dia, relaxamento à noite" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="uso-area pt-60 pb-60">
        <div class="container">
            <div class="uso">
                ...
                <div class="-img">
                    <img src="{{ bagisto_asset('img/produtos/cbd-daily-duo/como-usar.gif') }}" alt="Como usar o CBD Oil da Peels" />
                </div>
            </div>
        </div>
    </div>
