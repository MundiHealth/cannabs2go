                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-wrapper mb-30">
                            ...
                            <ul class="footer-link">
                                <li><b>WhatsApp:</b> <a href="https://api.whatsapp.com/send?phone=5511998680834" target="_blank">(11) 99868-0834</a></li>
                                <li><b>E-mail:</b> <a href="mailto:angelica@mypharma2go.com">angelica@mypharma2go.com</a></li>
                                <li><b>Envio de Prescrições:</b> <br> <a href="mailto:angelica@mypharma2go.com">angelica@mypharma2go.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <div class="footer-wrapper pl-25 mb-30">
                            ...
                            <ul class="footer-menu">
                                <li><a href="{{ route('customer.session.index') }}">Entrar</a></li>
                                <li><a href="{{ route('shop.checkout.cart.index') }}">Visualizar Carrinho</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="footer-wrapper pl-25 mb-30">
                            <div class="footer-logo bariatric">
                                <img src="{{ bagisto_asset('img/logo/cannabis2go-v2.svg') }}" alt="Cannabis2GO" />
                            </div>
                        </div>
                    </div>
                </div>
