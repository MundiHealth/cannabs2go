<form data-vv-scope="address-form" id="address-form" class="form">
        ...
        <div class=" col-xl-12 col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6" :class="[errors.has('address-form.billing[state]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|alpha'" class="control" id="billing[state]" name="billing[state]" maxlength="2" v-model="address.billing.state" v-if="!haveStates('billing')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;"/>
    ...
    @if ($cart->haveStockableItems())
        ...
        <div class="form-container" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4" :class="[errors.has('address-form.shipping[postcode]') ? 'has-error' : '']">
                        <label for="shipping[postcode]" class="required">
                            {{ __('shop::app.checkout.onepage.postcode') }}
                        </label>

                        <input type="text" v-validate="'required'" class="control" id="shipping[postcode]" name="shipping[postcode]" @keyup="searchAddress('shipping')" v-model="address.shipping.postcode" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.postcode') }}&quot;"/>
                        ...
                        @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                            <div class="col-xl-4 col-md-4">
                                @if($i == 1)
                                    ...
                                    <input v-validate="'required'" type="text" class="control" name="shipping[address1][{{ $i }}]" id="shipping_address_{{ $i }}" v-model="address.shipping.address1[{{$i}}]"  data-vv-as="&quot;{{ __('shop::app.checkout.onepage.number') }}&quot;">
                                @elseif($i == 2)
                                    <label for="shipping_address_0">
                                        {{ __('shop::app.checkout.onepage.complement') }}
                                    </label>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6" :class="[errors.has('address-form.shipping[state]') ? 'has-error' : '']">
                        ...
                        <input type="text" v-validate="'required|alpha'" class="control" id="shipping[state]" name="shipping[state]" maxlength="2" v-model="address.shipping.state" v-if="!haveStates('shipping')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.state') }}&quot;"/>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6" :class="[errors.has('address-form.shipping[taxvat]') ? 'has-error' : '']">
                        <label for="shipping[taxvat]" class="required">
                            {{ __('shop::app.checkout.onepage.taxvat') }}
                        </label>

                        <input type="text" v-validate="'required'" class="control" id="shipping[taxvat]" v-mask="['###.###.###-##']" name="shipping[taxvat]" v-model="address.shipping.taxvat" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.taxvat') }}&quot;"/>

                        <span class="control-error" v-if="errors.has('address-form.shipping[taxvat]')">
                        @{{ errors.first('address-form.shipping[taxvat]') }}
                    </span>
                    </div>
                </div>
            </div>
