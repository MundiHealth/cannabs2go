...
<li class="cart-icon">
    <a href="{{ route('shop.checkout.cart.index') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-shopping-cart"></i>
    </a>

    @if ($cart)

        <div class="cart-qty">{{ $cart->items()->sum('quantity') }}</div>
                    ...
                    @foreach ($items as $item)
                        ...
                        <li>
                            ...
                            <div class="widget-products-body">
                                ...
                                <p class="widget-products-price"><b>{{ core()->currency($item->base_total, $item->product) }}</b></p>
