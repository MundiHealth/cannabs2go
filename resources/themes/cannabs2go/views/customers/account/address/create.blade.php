            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-text text-center">
                        <h1>{{ __('shop::app.customer.account.address.create.address1') }}</h1>
                        <ul class="breadcrumb-menu">
                            <li><a href="{{url()->to('/customer/account/profile')}}">Minha Conta</a></li>
                            <li><span>{{ __('shop::app.customer.account.address.create.title') }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="account-content">
                        ...
                        <div class="account-layout">
                            ...
                            <form method="post" class="form" action="{{ route('customer.address.create') }}" @submit.prevent="onSubmit">
                                ...
                                <div class="account-table-content">
                                    ...
                                    <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="control" id="city" name="city" v-validate="'required'"
                                    ...
                                    <div class="control-group" :class="[errors.has('taxvat') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="control cpf" name="taxvat" v-validate="'required'"
                                               data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.taxvat') }}&quot;">
                                        <span class="control-error"
